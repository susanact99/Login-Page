...
import GOOGLE_IMG from '../assets/Google.webp';
      ...
      <div className='w-1/2 h-full bg-[#f5f5f5] flex flex-col p-20 justify-between'>
        ...
        <div className='w-full flex flex-col max-w-[550px]'>
          ...
          <div className='w-full flex flex-col my-4'>
            ...
            <button className='w-full text-[#060606] font-semibold my-2 border-2 bg-white border-black rounded-md p-2 text-center flex items-center justify-center'>
              Register
            </button>
          </div>
          ...
          <div className='w-full text-[#060606] font-semibold my-2 border-2 bg-white border-black rounded-md p-2 text-center flex items-center justify-center'>
